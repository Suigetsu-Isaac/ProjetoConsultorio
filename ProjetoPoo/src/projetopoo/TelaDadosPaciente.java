...
public class TelaDadosPaciente extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        LocalDate data = dataNascimento(String.valueOf(jFormattedTextField1.getValue()));
        Paciente p1 = new Paciente(nome, cpf,data, telefone, senha);
        JSONManager.salvarPaciente(p1);
