 ...
 * @author Daniel
 */
public class TelaDoPacienteDados extends javax.swing.JFrame {

    /**
     * Creates new form TelaDeLogin
     */
    public TelaDoPacienteDados() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaDoPacienteDados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaDoPacienteDados().setVisible(true);
            }
        });
    }
